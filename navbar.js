...
export default function Navbar() {
  return (
    ...
    <div className='w-full h-12 shadow-md bg-yellow-500'>
      NavBar
    </div>
    // <div className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-pink-500 mb-3 shadow-md">
